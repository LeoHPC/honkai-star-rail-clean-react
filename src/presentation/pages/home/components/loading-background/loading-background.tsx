export const LoadingBackground = () => {
  return (
    <div className="bg-loading-background bg-bottom bg-cover bg-no-repeat min-h-screen flex justify-center items-center flex-col">
      <div className="border-4 border-red-600 p-1 bg-gray-200 bg-opacity-50">
        <div className="bg-gray-900 bg-opacity-95 flex flex-col items-center justify-center gap-4 sm:py-8 py-6 sm:px-16 px-12">
          <svg
            aria-hidden="true"
            className="sm:w-16 w-12 sm:h-16 h-12 mr-2 text-gray-200 animate-spin fill-red-600"
            viewBox="0 0 100 101"
            fill="none"
